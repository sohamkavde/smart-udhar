...
router.post("/store-product/create", common.tokenmiddleware, uploadImage.single("product_image"), asyncHandler(createProduct));
router.post("/store-product/delete/:id", common.tokenmiddleware, asyncHandler(deleteProduct));
router.put("/store-product/update/:id", common.tokenmiddleware, uploadImageWithReplace("product_image"), asyncHandler(updateProduct));
...
router.get("/store-product/search", common.tokenmiddleware, asyncHandler(searchProducts));
